...
# /scratch/unath/Y90-Project/ExtractedFromISD_SILVA_HCC_Y90_1

#dataset_train = Y90PrePostDataset('/scratch/unath/Y90-Project/train/train_data', '/scratch/unath/Y90-Project/train/train_' + series +'.csv', patient_dict, train_type=0)
#train_loader = DataLoader(dataset_train, batch_size=4, shuffle=True)

#dataset_val = Y90PrePostDataset('/scratch/unath/Y90-Project/test/test_data', '/scratch/unath/Y90-Project/test/test_' + series +'.csv', patient_dict, train_type=1)
#val_loader = DataLoader(dataset_val, batch_size=4)

#dataset_train = Y90PrePostDataset('/scratch/unath/Y90-Project/ExtractedFromISD_SILVA_HCC_Y90_1', '/scratch/unath/Y90-Project/patientKey/train_data_top.csv', patient_dict, train_type=0)
#train_loader = DataLoader(dataset_train, batch_size=4, shuffle=True)
...
#path = "/data/yyang409/unath/pretrained_weights/classification/SiameseWeighteUnet3D/45.pt" 
